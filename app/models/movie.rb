...
has_many(:actors, :through => :characters, :foreign_key => "actor_id", :class_name => "Actor" )
#says that a movie has many actors, look through characters for actor_id and return class Actor
end
